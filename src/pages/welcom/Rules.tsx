...
const handleonClickNextButton = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-extendedColors-background-main">
      <div className="bg-extendedColors-background-rules p-6 rounded-3xl shadow-lg max-w-sm md:max-w-md lg:max-w-lg text-colors-black border-4 border-colors-colors-main-content">
        ...
        <p className="mt-4 text-center">
          Pełny regulamin znajdziesz <a href="#" className="text-colors-main-content underline">tutaj</a>
        </p>

        <div className='flex flex-row items-center justify-center'>
            <div className="flex items-center justify-center mt-6 pr-10">
            <label className="flex items-center space-x-2">
                <input type="checkbox" onChange={handleCheckBoxChange} className="form-checkbox h-5 w-5 text-colors-main-content" />
            ...
            <button onClick={handleonClickNextButton} className="bg-colors-main-content hover:bg-colors-main-hover text-black font-bold py-2 px-10 rounded-3xl border-2 border-colors-black">
                NEXT
            </button>
            </div>
        </div>
