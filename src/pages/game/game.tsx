...
const Game: React.FC = () => {
  ...
  return (
    <div className="bg-colors-main-content flex flex-col items-center min-h-screen pb-10">
          ...
          {cards.map(card => (
            ...
            >
              {card.flipped || card.matched ? (
                ...
                <img src='/images/logo.png' alt="card back" className="w-fit h-fit object-cover rounded-lg" />
              )}
            </div>
          ))}
        </div>
