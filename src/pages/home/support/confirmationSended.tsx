    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-extendedColors-background-main text-white space-y-6">
        ...
        <div className='flex flex-col justify-center items-center p-20 space-y-6'>
          ...
          <button onClick={backToHome} className="bg-colors-main-content text-black font-menuOptions700 py-4 px-8 rounded-full w-full">
            {t("btn.HOME PAGE")}
          </button>

          <button onClick={quitToSendMessage} className="bg-colors-main-content text-black font-menuOptions700 py-4 px-8 rounded-full w-full">
            {t("btn.QUIT")}
          </button>
